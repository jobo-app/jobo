...
describe JobsController do
  ...
  let(:valid_attributes) { { "company_name" => "MyString", "user_id" => guest.id } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested job" do
        ...
        Job.any_instance.should_receive(:update).with({ "company_name" => "MyString" })
        put :update, {:id => job.to_param, :job => { "company_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the job as @job" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Job.any_instance.stub(:save).and_return(false)
        put :update, {:id => job.to_param, :job => { "company_name" => "invalid value" }}, valid_session
        assigns(:job).should eq(job)
      end
